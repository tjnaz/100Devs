...
function canCharmanderFight(fahrenheit) {
  if (convertFahrenheitToCelcius(fahrenheit) <= 0) {
    console.log("Charmander can't fight");
  } else {
...
function battlePokemon(partySize) {
